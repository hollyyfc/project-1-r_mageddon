...
---
## What words appear more in election and non-election years? 

.pull-left[
``` {r data-prep-election-wordcloud, echo = FALSE}
...
``` {r election-wordcloud-viz, warning = FALSE, out.width = "60%", fig.width = 8, echo = FALSE}
election_df %>%
  ggplot(aes(
    label = word,
    color = sentiment,
...
.pull-right[
```{r non-election-wordcloud-data-prep,echo = FALSE}
...
``` {r non-election-wordcloud-viz, warning = FALSE, out.width = "60%", fig.width = 8, echo = FALSE}
non_election_df %>% 
  ggplot(aes(
    label = word,
    color = sentiment,
...
```{r wrangling_function, echo = FALSE}
...
```{r recode-features, echo = FALSE, warning = FALSE}
...
```{r plot-compare, warning = FALSE, out.width = "70%", fig.width = 8, echo = FALSE}
