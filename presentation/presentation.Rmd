...
```{r plotting stacked area chart, warning = FALSE, out.width = "70%", fig.height = 5, fig.width = 7, echo = FALSE}
...
```{r wrangling_function, echo = FALSE, warning = FALSE}
...
``` {r election-wordcloud-viz, warning = FALSE, out.width = "90%", fig.width = 8, fig.height = 9, echo = FALSE}
election_df %>%
  ggplot(aes(
    label = word,
    color = sentiment,
...
``` {r non-election-wordcloud-viz, out.width = "90%", fig.width = 8, fig.height = 9, echo = FALSE, warning = FALSE}
non_election_df %>% 
  ggplot(aes(
    label = word,
    color = sentiment,
...
.pull-left[
``` {r election-col-plot, out.width = "90%", fig.width = 9, fig.height = 8, echo = FALSE, warning = FALSE}
# Creating the plot
election_yr %>%
...
.pull-right[
```{r non-election-col-plot, out.width = "90%", fig.width = 9, fig.height = 8, echo = FALSE, warning = FALSE}
