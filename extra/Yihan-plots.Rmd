...
audience preferences, and engagement. To explore audience preference and engagement,
like_count, comment_count, and view_count are used to calculate ratio of like/engagement
over total views. We also use logical variables such as `funny`, `danger`, etc. 
to differentiate the changes over years by each feature.
...
We also used a stacked bar plot to see how the proportion of each feature change
over the years.
...
Comparing the line graphs with the stacked area plot, we can compare the changes 
in ads attributes and audience reactions toward them. From 2012 to 2020, the ads 
that contain dangerous elements are getting more likes than ads that do not contain 
dangerous elements, while significantly less ads contain dangerous content since 
2017. We think this decrease is due to stricter regulations rather than companies
catering to audience preference. Similarly, the use of sexuality in ads experienced 
a drop over the 20 years, while the audience' attitude toward this has fluctuated.
Therefore, policies against relevant content might be a main reason of decrease.

Over the years, `funny` and `show_product_quickly` take up the highest proportion 
among the seven video attributes. However, when the proportion of `funny` videos
grow from 2000 to 2003, audience tend to prefer the videos that do not contain humor.
There can be many underlying reasons, but one of our guesses is that the
expectation of humor is different between audience and ad companies. Also, including 
celebrity in the ads become popular in ads since 2015, which coincides with audience
preference. Companies might leverage the audience's love for celebrities, and the 
ads in turn strengthens the influence of celebrities.
