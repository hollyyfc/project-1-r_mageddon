...
.pull-left[
``` {r election-col-plot, out.width = "130%", fig.width = 15, fig.height = 20, echo = FALSE, warning = FALSE, cache = TRUE}
# Creating the plot
election_yr %>%
...
.pull-right[
```{r non-election-col-plot, out.width = "130%", fig.width = 15, fig.height = 20, echo = FALSE, warning = FALSE, cache = TRUE}
...
``` {r election-wordcloud-viz, warning = FALSE, out.width = "90%", fig.width = 10, fig.height = 9, echo = FALSE}
