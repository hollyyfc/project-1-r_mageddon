...
The `youtube` dataset contains a list of ads from the 10 brands that had the most
...
First, we used a stacked area chart to see how the proportion of each video 
...
than ads thatdo not contain dangerous elements. There is no obvious trend that 
...
## Question 2 <- 2. How do election year ads differ from non-election year ads in terms of content and description?
